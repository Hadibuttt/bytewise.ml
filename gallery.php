      ...
      <article>
        <header class="section background-dark">
          <div class="line">        
            ...
            <p class="margin-bottom-0 text-size-16">A Glimpse of the Designs made by our UI/UX Developer. Our designers aren't just good designers they are the best! <br>
            Special Thanks to Team Bytewise for making our clients delightful.</p>
          </div>  
        </header>
                ...
                <div class="image-with-hover-overlay image-hover-zoom margin-bottom">
                  <div class="image-hover-overlay background-primary"> 
                    <div class="image-hover-overlay-content text-center padding-2x">
                      <p>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse moleste.</p>  
                    </div> 
                  </div> 
